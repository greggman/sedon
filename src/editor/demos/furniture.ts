...
export function createFurnitureDemo(): {
  ...
  const floorMat = addNode(g, 'core/material', {
    position: { x: COL, y: 0 },
  ...
  const wallColor = addNode(g, 'core/solid-color', {
    position: { x: 0, y: ROW * 2 },
    inputValues: { color: [0.88, 0.85, 0.78, 1], resolution: 4 },
  });
  const wallMat = addNode(g, 'core/material', {
  ...
  const backWallLift = addNode(g, 'core/transform-scene', {
  ...
  const sideWallLift = addNode(g, 'core/transform-scene', {
  ...
  const chairPlace = addNode(g, 'core/transform-scene', {
  ...
  const tablePlace = addNode(g, 'core/transform-scene', {
  ...
  const sofaPlace = addNode(g, 'core/transform-scene', {
  ...
  const bookshelfPlace = addNode(g, 'core/transform-scene', {
  ...
  const fileCabinetPlace = addNode(g, 'core/transform-scene', {
